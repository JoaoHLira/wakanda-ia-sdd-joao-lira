...
| **AI Agent Instructions** | Rules and guidelines for AI execution | All commands |
...
/sdd.spec --include "https://confluence.mercadolibre.com/pages/..."
...
- **AUTO-TASK-E2E**: If `ltp.enabled: true` in meta.md AND functional spec contains E2E scenarios (`### E2E-N:`), generates E2E test task using E2E test framework
...
| All | `/sdd.build --layer 2` | Execute Layers 1-2 (local + fury) |
...
- 3-layer hook resolution: auto-declaration (skill frontmatter), repo config (`.claude/`), user config (`~/.sdd-kit/`)
