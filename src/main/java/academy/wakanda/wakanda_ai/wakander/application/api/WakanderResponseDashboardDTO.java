...
public class WakanderResponseDashboardDTO {
    ...
    @Schema(description = "Informações sobre os dados do asaas", example = "COMPLETO")
    private StatusDadosFiador statusDadosFiadorViaAsaas;

    @Schema(description = "Informações sobre o preenchimento dos dados pessoais via formulário", example = "COMPLETO")
    private StatusDadosFiador statusDadosPessoaisViaFormulario;

    public WakanderResponseDashboardDTO(Wakander wakander) {
        this.idWakander = wakander.getIdWakander();
        this.nome = NomeUtils.capitalizarNome(wakander.getNome());
        ...
        this.statusDadosPessoaisViaFormulario = wakander.verificaStatusPreenchimentoDadosPessoais();
        this.statusDadosFiadorViaAsaas = wakander.getFiador() == null ? StatusDadosFiador.INCOMPLETO :
                wakander.getFiador().verificaStatusPreenchimento();
    }
