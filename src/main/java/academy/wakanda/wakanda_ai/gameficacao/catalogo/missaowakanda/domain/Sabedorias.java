...
public class Sabedorias {
    ...
    public Sabedorias(int valorTeorico, int valorProcesso, int valorKnowHow, int valorComportamental,
                      int valorCriativo) {
    ...
    public static Sabedorias ofNullable(Sabedorias sabedorias) {
        if (sabedorias == null) {
            return new Sabedorias(0, 0, 0, 0, 0);
        }

        return new Sabedorias(Objects.requireNonNullElse(sabedorias.getTeorico(), 0),
    ...
    public boolean isEmpty() {
        return (teorico == null || teorico == 0) && (processo == null || processo == 0)
                && (knowHow == null || knowHow == 0) && (comportamental == null || comportamental == 0)
                && (criativo == null || criativo == 0);
    }

    public void atualizaSabedorias(Sabedorias sabedorias) {
        this.teorico = sabedorias.getTeorico();
        this.comportamental = sabedorias.getComportamental();
        this.criativo = sabedorias.getCriativo();
        this.knowHow = sabedorias.getKnowHow();
        this.processo = sabedorias.getProcesso();
    }
}
