...
| **Framework Commands** (features) | **IDE AI Chat** | `/sdd.start "my-feature"` |
...
### ✅ Framework Commands (IDE AI Chat Only)
```
...
> - Starts with `/sdd.` → Type in **IDE AI chat**
...
| **fury-services plugin** | ALWAYS use when "" is mentioned | Invoke `Skill("sdd-system-designer")` for selection or `Skill("sdd-implementer")` for SDK |
| ** App** | App must exist in your platform | Create at web.furycloud.io |
...
/sdd.spec --include "https://jira.mercadolibre.com/browse/PROJ-123"
/sdd.spec --include "https://confluence.mercadolibre.com/pages/viewpage.action?pageId=12345"
...
| App not found in  | Create at web.furycloud.io first |
...
| Resource | Location |
|----------|----------|
| Full Commands | `.sdd-kit/COMMANDS.md` |
| Workflow Guide | `.sdd-kit/WORKFLOW.md` |
| Governance | `~/.sdd-kit/standards/governance.md` |
| **Boundaries** | `~/.sdd-kit/standards/boundaries.md` |
| MCP Setup | `.sdd-kit/MCP_SETUP_GUIDE.md` |
| Templates | `~/.sdd-kit/templates/` |
| Standards | `~/.sdd-kit/standards/` |
