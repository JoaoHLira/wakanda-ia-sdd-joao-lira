# teste
aws --endpoint-url=http://localhost:4566 sns create-topic --name teste-topic.fifo --attributes FifoTopic=true
...
# zapi-requests
aws --endpoint-url=http://localhost:4566 sns create-topic --name zapi-requests-topic.fifo --attributes FifoTopic=true
...
# memberkit-requests
aws --endpoint-url=http://localhost:4566 sns create-topic --name memberkit-requests-topic.fifo --attributes FifoTopic=true
...
# asaas-requests
aws --endpoint-url=http://localhost:4566 sns create-topic --name asaas-requests-topic.fifo --attributes FifoTopic=true
...
# discord-requests
aws --endpoint-url=http://localhost:4566 sns create-topic --name discord-requests-topic.fifo --attributes FifoTopic=true
...
aws --endpoint-url=http://localhost:4566 sns create-topic --name progresso-wakander-requests-topic.fifo --attributes FifoTopic=true
...
aws --endpoint-url=http://localhost:4566 sns create-topic --name xp-wakander-requests-topic.fifo --attributes FifoTopic=true
